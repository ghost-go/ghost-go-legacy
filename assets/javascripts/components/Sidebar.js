        ...
        <div className="page-sidebar-wrapper">
          <div id="sidebar-top">
            ...
            <div className="tab-content">
              <div className="tab-pane clearfix fade active in" id="tab-example-1">
              ...
              <div className="tab-pane clearfix fade" id="tab-example-2">
              ...
              <div className="tab-pane clearfix fade" id="tab-example-3">
              ...
              <div className="tab-pane clearfix fade" id="tab-example-4">

      ...
      <MuiThemeProvider muiTheme={getMuiTheme()}>
        <div className="App">
          ...
          <div
            style={{
              marginLeft:
                this.props.ui.sidebar.collpased !== true ? "235px" : "50px",
            }}
          ...
          >
            ...
            <Route
              path="/problems/:id"
              render={(props) => (
                <Problem auth={auth} profile={this.state.profile} {...props} />
              )}
            />
            <Route
              path="/puzzles/:id"
            ...
            <Route
              path="/records"
              render={(props) => (
                <History auth={auth} profile={this.state.profile} {...props} />
              )}
            />
            <Route
              path="/dashboard"
            ...
            <Route
              path="/favorites"
              render={(props) => (
                <Favorite auth={auth} profile={this.state.profile} {...props} />
              )}
            />
            <Route
              path="/callback"

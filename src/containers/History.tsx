...
//     // dispatch(fetchPuzzleRecords({ page }));
//     // this.props.dispatch(
//     //   push(`/records?page=${page}&type=${query.get("type") || "all"}`)
//     // );
//   }
...
//     );
//     this.props.dispatch(
//       push(`/records?page=${query.get("page") || 1}&type=${val}`)
//     );
//   }
...
//         <RecordList
//           type="records"
//           recordList={records.data.data.map((i) => i.puzzle)}
//         />
//       );
...
//       recordList = (
//         <h3>
//           <b>You must login to access this page.</b>
//         </h3>
//       );
//     }
//     return (
...
//             <div className={css(styles.listContainer)}>{recordList}</div>
//             <div className={css(styles.pageContainer)}>{pagination}</div>
//           </div>
//         </div>
//       </div>
//     );

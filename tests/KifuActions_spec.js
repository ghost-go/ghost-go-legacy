...
describe('async actions', () => {
  ...
  it('creates FETCH_KIFUS_FAILURE when fetching kifus has been failure', (done) => {
    fetchMock
      .reMock('http://api.ghost-go.com/v1/kifu?page=1&per_page=1', 500)
